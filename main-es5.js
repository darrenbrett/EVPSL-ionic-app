...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function sendRequest(req) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["APIConfig"].url, "/").concat(req)).toPromise();
        }
      }, {
        key: "sendParamRequest",
        value: function sendParamRequest(req, params) {
          return this.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["APIConfig"].url, "/").concat(req, "/").concat(params)).toPromise();
        }
      }, {
        key: "sendPostRequest",
        value: function sendPostRequest(req, body) {
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["APIConfig"].url, "/").concat(req), body).toPromise();
        }
      }]);
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | standings-standings-module */
        [__webpack_require__.e("common"), __webpack_require__.e("standings-standings-module")]).then(__webpack_require__.bind(null,
        /*! ./standings/standings.module */
        "./src/app/standings/standings.module.ts")).then(function (m) {
          return m.StandingsPageModule;
        });
      },
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | scorers-scorers-module */
        [__webpack_require__.e("common"), __webpack_require__.e("scorers-scorers-module")]).then(__webpack_require__.bind(null,
        /*! ./scorers/scorers.module */
        "./src/app/scorers/scorers.module.ts")).then(function (m) {
          return m.ScorersPageModule;
        });
      },
      canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("common"), __webpack_require__.e("teams-teams-module")]).then(__webpack_require__.bind(null,
        /*! ./teams/teams.module */
        "./src/app/teams/teams.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | scores-scores-module */
        [__webpack_require__.e("common"), __webpack_require__.e("scores-scores-module")]).then(__webpack_require__.bind(null,
        /*! ./scores/scores.module */
        "./src/app/scores/scores.module.ts")).then(function (m) {
          return m.ScoresPageModule;
        });
      },
      canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    }, {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | predictions-predictions-module */
        "predictions-predictions-module").then(__webpack_require__.bind(null,
        /*! ./predictions/predictions.module */
        "./src/app/predictions/predictions.module.ts")).then(function (m) {
          return m.PredictionsPageModule;
        });
      }
    }];
  ...
  function srcAppAuthAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    req = "users/signup";
                    _context.next = 3;
                    return this.apiService.sendPostRequest(req, creds);
                  ...
                  case 10:
                    if (result && result.message === 'New user created successfully!') {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    this._userIsAuthenticated = true; // Store userDetails in localStorage
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], AuthService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/darrenking/Documents/EVPSL-Live/EVPSL-ionic-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
